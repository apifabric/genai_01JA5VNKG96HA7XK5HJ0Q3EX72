...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.InventoryItem, method_decorators= method_decorators)
    api.expose_object(database.models.Supplier, method_decorators= method_decorators)
    api.expose_object(database.models.MenuCategory, method_decorators= method_decorators)
    api.expose_object(database.models.MenuItem, method_decorators= method_decorators)
    api.expose_object(database.models.Order, method_decorators= method_decorators)
    api.expose_object(database.models.Table, method_decorators= method_decorators)

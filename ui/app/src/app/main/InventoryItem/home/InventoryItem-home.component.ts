...
@Component({
  selector: 'InventoryItem-home',
  templateUrl: './InventoryItem-home.component.html',
  styleUrls: ['./InventoryItem-home.component.scss']
})
export class InventoryItemHomeComponent implements AfterViewInit {

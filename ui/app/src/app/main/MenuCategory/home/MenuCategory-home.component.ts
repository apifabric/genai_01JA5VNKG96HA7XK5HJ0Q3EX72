...
@Component({
  selector: 'MenuCategory-home',
  templateUrl: './MenuCategory-home.component.html',
  styleUrls: ['./MenuCategory-home.component.scss']
})
export class MenuCategoryHomeComponent implements AfterViewInit {
